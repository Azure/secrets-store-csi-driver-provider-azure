...
To provide identity to access key vault, refer to the following [section](#provide-identity-to-access-key-vault).
  ...
  | objectVersionHistory   | no       | [__*available for version > v1.1.0*__] number of previous versions to sync, if not provided, will only sync the specified versions                                                                                                                                                      | 0             |
