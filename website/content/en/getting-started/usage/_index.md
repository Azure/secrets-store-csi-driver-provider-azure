...
To provide identity to access key vault, refer to the following [section](#provide-identity-to-access-key-vault).
  ...
  | objectKeyFile            | no       | [__*available for version > 1.1.0*__] specify the key filename of the pkcs12 secret when written to disk - must provide objectCertFile as well; mutually exclusive with objectAlias                                                                                 | ""            |
  | objectCertFile            | no       | [__*available for version > 1.1.0*__] specify the cert filename of the pkcs12 secret when written to disk - must provide objectKeyFile as well; mutually exclusive with objectAlias                                                                                 | ""            |
