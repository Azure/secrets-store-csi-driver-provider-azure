...
type Config struct {
	...
	ImageVersion                      string `envconfig:"IMAGE_VERSION" default:"v1.0.1"`
	...
	IsConformanceTest                 bool   `envconfig:"IS_CONFORMANCE_TEST" default:"false"`
}
...
func (c *Config) DeepCopy() *Config {
	...
	copy.IsConformanceTest = c.IsConformanceTest
