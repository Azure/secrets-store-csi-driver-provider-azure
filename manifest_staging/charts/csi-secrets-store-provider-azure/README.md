...
| `secrets-store-csi-driver.linux.livenessProbeImage.tag`          | Driver Linux liveness-probe image tag                                                                                         | `v2.1.0`                                                                                         |
...
| `secrets-store-csi-driver.windows.livenessProbeImage.tag`        | Driver Windows liveness-probe image tag                                                                                       | `v2.1.0`                                                                                         |
