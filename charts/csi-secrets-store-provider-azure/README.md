...
| `image.repository`                                               | Image repository [**DEPRECATED**]. Use `linux.image.repository` and `windows.image.repository` instead.                       | `""`                                                                                             |
| `image.pullPolicy`                                               | Image pull policy [**DEPRECATED**]. Use `linux.image.pullPolicy` and `windows.image.pullPolicy` instead.                      | `""`                                                                                             |
| `image.tag`                                                      | Azure Keyvault Provider image [**DEPRECATED**]. Use `linux.image.tag` and `windows.image.tag` instead.                        | `""`                                                                                             |
...
| `secrets-store-csi-driver.linux.livenessProbeImage.tag`          | Driver Linux liveness-probe image tag                                                                                         | `v2.2.0`                                                                                         |
...
| `secrets-store-csi-driver.windows.livenessProbeImage.tag`        | Driver Windows liveness-probe image tag                                                                                       | `v2.2.0`                                                                                         |
...
| `customUserAgent`                                                | Custom user agent to add to adal and keyvault requests                                                                        | `""`                                                                                             |
